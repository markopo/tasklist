System.register(["@angular/core", "@angular/platform-browser-dynamic"], function (exports_1, context_1) {
    ...
    var core_1, platform_browser_dynamic_1, CountdownComponent, PomodoroTimerComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ...
            PomodoroTimerComponent = (function () {
                ...
                PomodoroTimerComponent.prototype.setVisible = function () {
                    return this.isVisible ? 'inline-block' : 'none';
                };
